    ...
    <section className="py-16 md:py-24 bg-[#e7ddcc] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="space-y-6 text-lg text-gray-700 font-light max-w-2xl mx-auto">
          <p>
          في اورزي ١٩٩٨ <br/> نحن لا نصمم مجرد إكسسوارات أو أساور، <br/> بل نبتكر قطعاً فنية مُستلهمة من أصالة "الزمن الجميل". <br/> نحن نؤمن بأن القطعة التي تختارها هي امتدادٌ لمظهرك؛ لذا نصيغ إبداعاتنا لتمنح الرجل هيبةً طاغية ورونقاً استثنائياً، وتُبرز للمرأة رقتها الأخاذة وجمالها الحقيقي الذي ينبع من الداخل.
          </p>
          <p>
